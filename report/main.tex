...
trauma~\cite{ringdal_utstein_2008} or \Cref{tab:predictors} in the appendix.
...
score (\acrshort{auc}: 0.449 [0.424, 0.474]). See \Cref{tab:modelperf} for \acrshort{auc} metrics for all
classification models in each data group and corresponding \acrshortpl{ci}.
...
reported varied performances of synthetic data generation using \acrlongpl{gan} in different medical contexts. One
...
the previously used classification model. This has been explored with using \acrshortpl{gan} for classification by
