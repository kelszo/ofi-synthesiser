...
The classification models were trained on either the raw resample's training data, the synthesising models output, or a combination of both. For each training cycle the classification models were trained on the raw test data from the train-test split.
